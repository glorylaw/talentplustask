...
function Navbar() {
  ...
  return (
    ...
    <ul className='hidden md:flex text-white item-left'>
    <li>Home</li>
    <li>About Us</li>
    <li>Courses</li>
    <li>Testimonials</li>
    ...
    <button className='px-8 py-3 mt-3'>Enroll Now</button>
    </div>
    <div className='md:hidden'>
    <MenuIcon className='w-5 pt-5 text-white'/>
    </div>
      </div>

      <ul className='absolute bg-[#004DB3] w-full px-8 text-white'>
      ...
      <div>
        <button className='px-8 py-3 mt-2 mb-2'>Enroll Now</button>
      </div>
      </ul>
